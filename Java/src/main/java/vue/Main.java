...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException, Exception {
        ...
        System.out.println("2. Scénario complet avec plusieurs élèves qui se voient accorder ou refuser leurs inscriptions, connexions et soutiens");
    ...
    public static void scenarioMdpIncorrect(Service service) {
        System.out.println("Scénario A- Erreur de connexion d'élève (mauvais mdp)");
        ...
        System.out.println("Scénario B - Erreur de connexion d'intervenant");
    ...
    private static void scenario1(Service service) throws ParseException, Exception {
        ...
        try {
            ...
            System.out.println("\u001b[34m" + "(par exemple, pour la première matière qui s'affiche, entrez le numéro 0)");
            ...
            soutienIntervenant = service.refreshSoutien(soutienIntervenant) ;
            ...
            System.out.println("\u001b[31m" + "IPS moyen des établissements des soutiens : : " + service.statIpsMoyenSoutien());
    ...
    private static void scenario2(Service service) throws ParseException, Exception {
        ...
        try {
            ...
            for (Soutien soutien : historique_intervenant2) {
            ...
            for (Soutien soutien : historique_intervenant3) {
            ...
            for (Soutien soutien : historique_intervenant4) {
            ...
            System.out.println(historique_intervenant6);
            StringBuilder sb_intervenant6 = new StringBuilder();
            for (Soutien soutien : historique_intervenant6) {
            ...
            System.out.println("\u001b[33m" + "Historique " + intervenant6.getNom() + " " + intervenant6.getPrenom() + " " + sb_intervenant6);
            ...
            System.out.println("\u001b[31m" + "Satisfaction moyenne des élèves : " + service.statSatisfactionEleve() + "/5");
            System.out.println("\u001b[31m" + "Intervenant du mois : " + service.statIntervenantMois());
            System.out.println("\u001b[31m" + "IPS moyen des établissements des soutiens :s des élèves sollicitant un soutien : " + service.statIpsMoyenSoutien());
            System.out.println("\u001b[31m" + "Quantite d'intervention par coordonnées : " + service.statQuantiteSoutienParCoordonnees());
            System.out.println("\u001b[31m" + "======================");
    ...
    private static void scenarioSujet(Service service) throws ParseException, Exception {
        ...
        try {
            ...
            List<Soutien> historique_alice = service.trouverHistoriqueEleve(alice);
            StringBuilder sb_alice = new StringBuilder();
            for (Soutien s : historique_alice) {
                sb_alice.append(String.format("Date: %s, Intervenant: %s %s, Matière: %s, Bilan: %s ; ",
                        soutien.getDate(),
                        soutien.getIntervenant().getPrenom(),
                        soutien.getIntervenant().getNom(),
                        soutien.getMatiere().getNom(),
            ...
            System.out.println("\u001b[33m" + "Historique Alice : " + sb_alice);

            //L'intervenant accède a l'historique de ses interventions
            System.out.println("\u001b[33m" + "=====HISTORIQUE INTERVENANT=====");

            List<Soutien> historique_camille = service.trouverHistoriqueIntervenant(camille.getId());
            StringBuilder sb_camille = new StringBuilder();
            for (Soutien s : historique_camille) {
                sb_camille.append(String.format("Date: %s, Eleve: %s %s, Matière: %s, Bilan: %s ; ",
                        soutien.getDate(),
                        soutien.getEleve().getPrenom(),
                        soutien.getEleve().getNom(),
                        soutien.getMatiere().getNom(),
            ...
            System.out.println("\u001b[33m" + "Historique Camille : " + sb_camille);
